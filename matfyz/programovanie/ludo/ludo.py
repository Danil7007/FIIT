...
class Plocha:
    def __init__(self, subor, *pole):
        ...
        self.canvas.pack()
        self.canvas.create_image(200, 200, image=self.bg, anchor='nw')
...
win = tkinter.Tk()
pole1 = [tkinter.PhotoImage(file='C:\DATA\FIIT\matfyz\programovanie\ludo\d{}.gif'.format(i)) for i in range(6)]
pole2 = [tkinter.PhotoImage(file='C:\DATA\FIIT\matfyz\programovanie\ludo\d{}.gif'.format(i)) for i in range(6)]
