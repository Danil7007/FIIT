...
public abstract class Turnaj extends Turnaje implements Serializable {
    ...
    protected PrvyZapasPozorovatel pozorovatel;

    public void obnovPozorovatela(){
        pozorovatel.update(zapasy.get(0));
    }

    public void vytvorPozorovatela(){
        this.pozorovatel = new PrvyZapasPozorovatel();
    }
