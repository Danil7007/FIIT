...
public class TurnajC extends Turnaj {
    ...
    public TurnajC (int pocetDni, boolean leto, int velkostPavuka, Date zaciatokTurnaja, ArrayList<Hrac> hraci) {
        super();
        this.kategoria = new Kategoria('C', leto); // instanciuje kategoriu
