/*
Napíšte funkciu funckiu void nasob(int m1[][N], int m2[][N], int m3[][N]) na
vynásobenie štvorcových matíc m1 a m2 a zapíše výsledok do matice m3. Funkciu doplňte ju do
programu z prednášky.
*/
