...
void hladaj (KNIHA* head); // hladanie zaznamov
...
int main() {
  ...
  // POZNAMKA - V TEJTO VERZII SOM ODSTRANILA V MAINE NACITANIE ENTERU
  // LEBO SOM TO SPUSTALA V INOM COMPILERI A NEVIEM Z AKEHO DOVODU MI TO NESLO
  // ALE TAKTO TO IDE V OBOCH CIZE
