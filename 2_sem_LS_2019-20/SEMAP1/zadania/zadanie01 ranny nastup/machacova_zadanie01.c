// meno: Emma Machacova
// vyvojove prostredie/kompilator: https://www.onlinegdb.com/online_c_compiler
...
int main(){
    ...
    do {
        ...
        // ak trieda vojaka nie je oznacena a-z alebo A-Z (inak rozlisuje ako triedu aj medzeru alebo iny znak a uspesne triedi)
        // 'a' nie je rovnaka trieda ako 'A', lebo mi nie je jasne zo zadania ci to ma byt brane ako rozdielna trieda alebo nie
        /*
        if (!(skenC >= 'A' && skenC <= 'Z' || skenC >= 'a' && skenC <= 'z')){
